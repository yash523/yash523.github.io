var controlpiecetop,controlpiecebottom,controlpieceleft,controlpieceright;
var gameball;
var scorebox;
var score=0;
function startGame() {
    controlpiecetop = new component(80,5,"black",260,0);
    controlpiecebottom = new component(80,5,"black",260,595);
    controlpieceleft= new component(5,80,"black",0,260);
    controlpieceright= new component(5,80,"black",795,260);
    scorebox= new component("30px", "Consolas", "black", 280, 40, "text");
    gameball = new comp(10,"black",250+Math.floor(Math.random() * 300),200+Math.floor(Math.random() * 200));
    myGameArea.start();
}
var myGameArea = {
...
function updateGameArea() {
    ...
    if(gameball.x<=controlpieceleft.width+gameball.radius && gameball.y >=controlpieceleft.y && gameball.y <=controlpieceleft.y+controlpieceleft.height)
       {gameball.speedX*=-1;gameball.speedX+=0.5;score++;}
    ...
    if(gameball.y<=controlpiecetop.height+gameball.radius && gameball.x >=controlpiecetop.x && gameball.x <=controlpiecetop.x+controlpiecetop.width)
       {gameball.speedY*=-1;gameball.speedY+=0.5;score++;}
